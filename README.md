...
> To check the Node.js version run installed in your compouter, run `node -v`. You should see something like this `v8.11.3`. If you don't have Node.js installed, use the above link to download and install it.

## Installation

[Clone](https://help.github.com/articles/cloning-a-repository/) the project to your computer.

Inside the directory of the cloned project, run `npm i` to install the dev dependencies.

## Tests' setup

There are only two files you will have to change to get the project configured to run screenshot comparison tests for you website, they are [`test/backstopSettings.js`](./test/backstopSettings.js), and [`test/relativePaths.js`](./test/relativePaths.js). Update these files by following the instructions in the comments of each of them.
